...
df = pd.read_csv('chatbot/chatbotServer/chatbot_conv/intent_classification/raw_data/chatbot_dataset.csv')
df = df.sample(frac=1)
train_df = df[300:]
test_df  = df[:300]
train_df.to_csv("chatbot/chatbotServer/chatbot_conv/intent_classification/train_data/train_data_chatbot.csv", index=False)
test_df.to_csv("chatbot/chatbotServer/chatbot_conv/intent_classification/train_data/test_data_chatbot.csv", index=False)
...
train_data, test_data = TabularDataset.splits(
        path='chatbot/chatbotServer/chatbot_conv/intent_classification/train_data/', train='train_data_chatbot.csv', test='test_data_chatbot.csv', format='csv',
...
save_vocab(TEXT.vocab,'chatbot/chatbotServer/chatbot_conv/intent_classification/dict_vocab.tsv')
...
torch.save(model.state_dict(), 'chatbot/chatbotServer/chatbot_conv/intent_classification/train_state/intent_state.pt')
